...
<div class="right_col" role="main">
          <div class="">          
    <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>TAMBAH SEMESTER BARU</b></a><br><br>
    
    <form action="<?=base_url('admin/insert_semester')?>" method="post">
    <div class="row">
    <div class="col">
    <div class="container">
        ...
        <input type="text" name="nama_semester" class="form-control" maxlength="50" placeholder="Semester" required>
        </div>  
        <div class="form-group">
