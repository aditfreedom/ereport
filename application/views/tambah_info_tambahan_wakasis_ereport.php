...
<div class="right_col" role="main">
          <div class="">          
    <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>TAMBAH INFORMASI WAKASIS</b></a><br><br>
    
    <form action="<?=base_url('admin/insert_info_tambahan_wakasis')?>" method="post">
    <div class="row">
    <div class="col">
    <div class="container">
        ...
        <textarea name="info" cols="30" maxlength="950"  rows="10" class="form-control" placeholder="Isi Deskripsi"></textarea>
        </div>  
        ...
        <button type="submit" id="btn" class="btn btn-primary form-control font-weight-bold">PUBLSH INFORMASI</button><br><br>
        </form>
