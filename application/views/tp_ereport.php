...
<div class="right_col" role="main">
          <div class="">
          <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>TAHUN PELAJARAN</b></a><br><br>
            <p align="left">
              <a class="btn btn-success font-weight-bold" href="<?=base_url('admin/tambah_tp')?>">TAMBAH DATA</a>
            </p>
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <td scope="row"><?php echo $i; ?></td>
                      ...
                      <td><?php echo $text; ?></td>
                     <td><?php echo anchor('admin/edit_tp/'.$data->id_tp,'<div class="btn btn-primary btn-sm"><b>EDIT DATA</b></div>')?> 
                      <?php echo anchor('admin/hapus_tp/'.$data->id_tp,'<div class="btn btn-danger btn-sm text-bold"><b>HAPUS DATA</b></div>')?></td>
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
                </tbody>
