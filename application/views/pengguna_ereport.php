...
<div class="right_col" role="main">
          <div class="">
          <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>DATA PENGGUNA</b></a><br><br>
            <p align="left">
              <a class="btn btn-success font-weight-bold" href="<?=base_url('admin/tambah_user')?>">TAMBAH DATA</a>
            </p>
                ...
                <tbody>
                  ...
                  foreach ($user as $data) : ?>
                    ...
                    <td scope="row"><?php echo $i; ?></td>
                      <td scope="row"><?php echo $data->nama_user; ?></td>
                      <td><?php echo $data->role; ?></td>
                     <td><?php echo anchor('admin/edit_user/'.$data->id_user,'<div class="btn btn-primary btn-sm"><b>EDIT DATA</b></div>')?> 
                      <?php echo anchor('admin/hapus_user/'.$data->id_user,'<div class="btn btn-danger btn-sm text-bold"><b>HAPUS DATA</b></div>')?></td>
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
                </tbody>
