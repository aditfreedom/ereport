...
<?php
  ...
  ?>
          <div class="">
          <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>LAPORAN BASE CLASS WALI KELAS</b></a><br><br>
            <p align="left" <?=$hidden_kepsek?>>
              <a class="btn btn-success font-weight-bold" href="<?=base_url('admin/tambah_form_walas')?>">TAMBAH LAPORAN WALI KELAS</a>
            </p>
            ...
            <table class="table table-bordered table-stripped" id="example">
                <thead class="text-center">
                  ...
                  <th scope="col">NO</th>
                    ...
                    <th scope="col">TANGGAL BASE CLASS</th>
                    <th scope="col">WAKTU BASE CLASS</th>
                ...
                <tbody>
                  ...
                  foreach ($walas as $data) : ?>
                    ...
                    <td scope="row"><?php echo $i; ?></td>
                     ...
                     <td><a href="<?=base_url('admin/baca_form_walas/').$data->id_form_walas?>" class="btn btn-sm btn-success"><b>BACA REPORT</u></a>
                         <a <?=$hidden_kepsek?> href="<?=base_url('admin/edit_form_walas/').$data->id_form_walas?>" class="btn btn-sm btn-primary"><b>EDIT REPORT</u></a>
                         <a <?=$hidden_kepsek?> href="<?=base_url('admin/hapus_form_walas/').$data->id_form_walas?>" class="btn btn-sm btn-danger"><b>HAPUS REPORT</u></a>
                    </td>
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
