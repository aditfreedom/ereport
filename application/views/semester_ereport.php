...
<div class="right_col" role="main">
          <div class="">
          <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>DAFTAR SEMESTER</b></a><br><br>
            <p align="left">
              <a class="btn btn-success font-weight-bold" href="<?=base_url('admin/tambah_semester')?>">TAMBAH DATA</a>
            </p>
                ...
                <tbody>
                  ...
                  foreach ($semester as $data) : ?>
                    ...
                    <td scope="row"><?php echo $i; ?></td>
                      <td scope="row"><?php echo $data->nama_semester; ?></td>
                      <td><?php echo $data->status; ?></td>
                     <td><?php echo anchor('admin/edit_semester/'.$data->id_semester,'<div class="btn btn-primary btn-sm"><b>EDIT DATA</b></div>')?> 
                      <?php echo anchor('admin/hapus_semester/'.$data->id_semester,'<div class="btn btn-danger btn-sm text-bold"><b>HAPUS DATA</b></div>')?></td>
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
                </tbody>
