...
<div class="right_col" role="main">
          <div class="">
          <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>ROLE PENGGUNA</b></a><br><br>
            <!-- <p align="left">
              <a class="btn btn-success font-weight-bold" href="<?=base_url('admin/tambah_role')?>">TAMBAH DATA</a>
            </p> -->
                ...
                <tbody>
                  ...
                  foreach ($role as $data) : ?>
                    <tr class="nomor text-center">
                      ...
                      <!-- <td><?php echo anchor('admin/edit_bpp/'.$data->id,'<div class="btn btn-primary btn-sm"><b>EDIT DATA</b></div>')?> 
                      <?php echo anchor('admin/hapus_bpp/'.$data->id,'<div class="btn btn-danger btn-sm text-bold"><b>HAPUS DATA</b></div>')?></td> -->
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
                </tbody>
