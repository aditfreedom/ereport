  ...
  <tr>
    ...
    <td colspan="5"></td>
        ...
        <hr>
          ...
          <hr>
          <div class="form-group">
          <textarea required name="kondisi_psiko" cols="30" maxlength="5000"  rows="5" class="form-control" placeholder="Deskripsi Psiko-sosial Kelas">
          <?php foreach ($data_tanggal as $data) : ?>
          ...
          <hr>
          <div class="form-group">
          <textarea required name="kondisi_fisik" cols="30" maxlength="5000"  rows="5" class="form-control" placeholder="Deskripsi Kondisi Fisik Kelas">
          <?php foreach ($data_tanggal as $data) : ?>
          <?=$data->follow_up?>
          <?php endforeach; ?>
          </textarea>
