      ...
      <div class="row">
        <div class="col">
          <div class="container">
            ...
            <table border=1 class="text-dark" style="undefined;table-layout: fixed; width: 100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Keterlambatan</td>
                  <td><input type="number" name="jlh_terlambat" class="form-control border border-dark" maxlength="5" required></td>
                  </td>
                  <td><input type="number" name="persen_terlambat" class="form-control border border-dark" maxlength="5" required></td>
                  </td>
                  <td><input type="text" name="keterangan_terlambat" class="form-control border border-dark" maxlength="100" required></td>
                  </td>
                </tr>
                <tr>
            ...
            <hr>
            <h3 class="text-dark">DESKRIPSI KEGIATAN : </h3>
            <hr>

            <div class="form-group">
              <textarea required name="kondisi_akademik" cols="30" maxlength="5000" rows="5" class="form-control" placeholder="Deskripsi Kelas">
          ...
          <?php endforeach; ?>
            ...
            <hr>
            <h3 class="text-dark">PERMASALAHAN KELAS :</h3>
            <hr>
            <div class="form-group">
              <textarea required name="kondisi_psiko" cols="30" maxlength="5000" rows="5" class="form-control" placeholder="Permasalahan Kelas">
          <?php foreach ($data_tanggal as $data) : ?>
          ...
          <?php endforeach; ?>
            ...
            <hr>
            <h3 class="text-dark">HASIL BELAJAR GURU :</h3>
            <hr>
            <div class="form-group">
              <textarea required name="kondisi_fisik" cols="30" maxlength="5000" rows="5" class="form-control" placeholder="Hasil Belajar Guru">
          <?php foreach ($data_tanggal as $data) : ?>
          <?= $data->follow_up ?>
          <?php endforeach; ?>
          </textarea>
