...
<div class="right_col" role="main">
          <div class="">          
    <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>TAMBAH INFORMASI</b></a><br><br>
    
    <form action="<?=base_url('admin/insert_info_tambahan')?>" method="post">
    <div class="row">
    <div class="col">
    <div class="container">
