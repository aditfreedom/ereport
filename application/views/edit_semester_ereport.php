...
<div class="right_col" role="main">
          <div class="">          
    <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>EDIT SEMESTER</b></a><br><br>
    <form action="<?=base_url('admin/update_semester')?>" method="post">

    <div class="row">
    <div class="col">
    <div class="container">
    <?php foreach ($edit_semester as $data) : ?>
    ...
    <div class="form-group" hidden>
        ...
        <input type="text" name="id_semester" class="form-control" maxlength="50" placeholder="Judul Informasi" value="<?=$data->id_semester?>">
        </div>  
        <div class="form-group">
        <label for=""><b>SEMESTER : </b></label>
        <input  type="text" name="nama_semester" class="form-control" maxlength="50" placeholder="Semester" value="<?=$data->nama_semester?>">
        </div>  
        <div class="form-group">
