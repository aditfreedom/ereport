...
<div class="right_col" role="main">
          <div class="">          
    <a href="#" class="btn btn-danger rounded-pill text-left" style="width:100%"><b>TAMBAH ROLE PENGGUNA</b></a><br><br>
    ...
    <div class="container">
        ...
        <input type="text" name="role" class="form-control" value="0"  required>
        </div>  
